...
if __name__ == "__main__":
    ...
    parser.add_argument('--task-index', type=int, default=None, help='Index of the task to run (0-4)')
    parser.add_argument('--task2-path', type=str, default=None, help='Path to the task 2 test case file')
    args = parser.parse_args()

    if args.task2_path:
        main(args.task2_path, '-1')
